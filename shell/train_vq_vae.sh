...
# Output and Logging
CHECKPOINT_DIR="/home/chaitanya-kohli/Amex/TimeVQDM/TSTR_checkpoints/TSTR_${CLASS_FUNC}_${CLASSIFICATION_LOSS_WEIGHT}_l${NUM_LAYERS}h${NUM_HEADS}_VQ${NUM_EMBEDDINGS}"
mkdir -p "${CHECKPOINT_DIR}"

# Weights & Biases Configuration
WANDB_PROJECT="syth-amex-tstr"
WANDB_ENTITY=""
WANDB_RUN_NAME="TSTR_${CLASS_FUNC}_${CLASSIFICATION_LOSS_WEIGHT}_l${NUM_LAYERS}h${NUM_HEADS}_VQ${NUM_EMBEDDINGS}_$(date +%d%m_%H%M%S)"
