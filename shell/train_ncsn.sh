...
TRANSFORMER_PATH="/home/s25090/Amex/TimeVQDM/quantile_transformer.pkl"
FILL_DICT_PATH="/home/s25090/Amex/TimeVQDM/fill_dict.pkl"

# 3. Target Pre-trained VQ-VAE Checkpoint
VQ_VAE_CHECKPOINT="/scratch/s25090/Amex_checkpoints/knn_0.5_l12h8_VQ512/best_model.pt"

# 4. NCSN Specific Configuration
DENOISER_HIDDEN_DIM=512
LEARNING_RATE=1e-4  # Standard for diffusion/score models 
NUM_EPOCHS=100
BATCH_SIZE=256
VAL_BATCH_SIZE=256
NCSN_NUM_BLOCKS=3
...
CHECKPOINT_DIR="/scratch/s25090/Amex_checkpoints/${DENOISER_MODEL}_NCSN_denoiser_${DENOISER_HIDDEN_DIM}_l_${NCSN_NUM_BLOCKS}"
...
cd /home/s25090/Amex/TimeVQDM
export PYTHONPATH="/home/s25090/Amex/TimeVQDM:${PYTHONPATH:-}"

echo "Starting NCSN Training..."
echo "Using VQ-VAE Checkpoint: ${VQ_VAE_CHECKPOINT}"

CUDA_VISIBLE_DEVICES=2 python train_ncsn.py \
